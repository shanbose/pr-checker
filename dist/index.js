...
const pullRequestChecker = __importStar(__webpack_require__(875));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (checkerArguments.onePassAllPass === 'true' &&
                commits.length > failed.length) {
                return;
            }
            if (failed.length > 0) {
                const summary = inputHelper.genOutput(failed, checkerArguments.preErrorMsg, checkerArguments.postErrorMsg);
...
var mergeConfig = __webpack_require__(825);
var buildFullPath = __webpack_require__(960);
var validator = __webpack_require__(335);
 ...
 * @returns   string
 */
function checkPullRequest(args, sha, message) {
